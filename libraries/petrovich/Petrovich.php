...
class Petrovich {
    ...
    */
     ...
     * @throws Exception
     */
    public function setSex($sex = Petrovich::GENDER_ANDROGYNOUS) {
        switch ($sex) {
            default:
            case Petrovich::GENDER_ANDROGYNOUS:
                $this -> gender = Petrovich::GENDER_ANDROGYNOUS;
            break;
            case Petrovich::GENDER_MALE:
                $this -> gender = Petrovich::GENDER_MALE;
            break;
            case Petrovich::GENDER_FEMALE:
